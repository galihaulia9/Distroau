<div class="container">
	<div class="row">
		...
		$nameErr = $emailErr = $addressErr = $cityErr = $stateErr = $zipErr = $phoneErr = $ownerErr = $cardbankErr = $cardnumberErr = $payErr = "";
		...
		if(isset($_POST['checkout'])){
			if($_SERVER['REQUEST_METHOD'] == "POST"){
				...
				if(empty($_POST['owner'])){
					$error = true;
					$ownerErr = "Masukkan nama pemilik rekening bank Anda";
				}else{
					$owner = $_POST['owner'];
				...
				if(trim($_POST['card_bank'])=="blank"){
					$error = true;
					$cardbankErr = "Pilih salah satu nama asal bank Anda";
				}else{
		...
		<form action="../index.php?p=checkout" class="form-horizontal" method="POST">
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					...
					<span>Example: yourname@gmail.com</span>
			...
			<div class="form-group">
				<label class="col-md-2 control-label">Asal Bank</label>
				<div class="col-md-3">
					<select name="card_bank" id="card_bank" class="form-control">
						<option value="blank">-- Pilih Bank Asal--</option>
						<option value="Bank BCA" <?php echo $cardbankErr; ?>>Bank BCA</option>
						<option value="Bank Mandiri" <?php echo $cardbankErr; ?>>Bank Mandiri</option>
						<option value="Bank BNI" <?php echo $cardbankErr; ?>>Bank BNI</option>
						<option value="Bank BRI" <?php echo $cardbankErr; ?>>Bank BRI</option>
					</select>
