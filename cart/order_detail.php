<div id="divToPrint">
	<div class="container">
		<div class="row">
			<div class="col-xs-6">
				<img class="logo-img" src="../logo/distroau.png" />
			</div>
			<div class="col-xs-6 text-right"  style="margin-top: 20px;">
				<address>
				Jl. Rungkut Madya, Gn.Anyar, Surabaya<br/>
				Telepon : 08123456789<br/>
				Email : ourwebsite@distroau.com
				</address>
			</div>
				<?php 
...
<div class="container" style="margin-bottom:20px;">
	<div class="shopping-right-basket">
		...
		<input type="button" value="Cetak" class="btn-continue" onclick="PrintDiv('divToPrint')">
