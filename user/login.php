<div class="container">
	<h1 class="well"><center>Login Distro-AU</center></h1>
				...
				<div class="col-sm-12">
					<div class="row">
						...
						<div class="col-sm-6 form-group">
							...
							<div class="input-group">
								<input type="password" id="password" name="password" placeholder="Masukkan sandi" class="form-control">
					...
					<center>
						<div class="form-group">
							<button type="submit" class="btn btn-warning" name="signin">Login</button>
	...
	<div class="well"><p class="text-center new-account">Apakah Anda Sudah Mendaftar? <a href="../index.php?p=register">Buat akun baru</a></p></div>
</div>