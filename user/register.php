<div class="container">
	<h1 class="well"><center>Pendaftaran Distro-AU</center></h1>
				...
				<div class="col-sm-12">
					<div class="row">
						<div class="col-sm-6 form-group">
							...
							<input type="text" class="form-control" name="fname" placeholder="Masukan nama pertama Anda" value="<?php echo isset($fname) ? $fname : ' ';?>">
							<span class="text-danger msg-error"><?php echo $fnameErr; ?></span>
						</div>
							
						<div class="col-sm-6 form-group">
							<label>Nama Terakhir :</label>
							<input type="text" class="form-control" name="lname" placeholder="Masukan nama terakhir Anda" value="<?php echo isset($lname) ? $lname : ' ';?>">
					...
					<div class="row">
						<div class="col-sm-6 form-group">
							...
							<select name="gender" class="form-control">
								...
								<option value="Laki-laki" <?php echo $gender ?>>Laki-laki</option>
								<option value="Perempuan" <?php echo $gender ?>>Perempuan</option>
							</select>
					...
					<div class="row">
						<div class="col-sm-12 form-group">
							<label>Alamat :</label>
							<input type="text" class="form-control" name="address" placeholder="Masukan alamat rumah" value="<?php echo isset($address) ? $address : ' ';?>">
					...
					<div class="row">
						<div class="col-sm-6 form-group">
							<label>Kota :</label>
							<input type="text" class="form-control" name="city" placeholder="Masukan nama kota" value="<?php echo isset($city) ? $city : ' ';?>">
							<span class="text-danger msg-error"><?php echo $cityErr; ?></span>
						</div>
							
						<div class="col-sm-6 form-group">
							<label>Provinsi :</label>
							<input type="text" class="form-control" name="state" placeholder="Masukan nama provinsi" value="<?php echo isset($state) ? $state : ' ';?>">
					...
					<div class="row">
						<div class="col-sm-6 form-group">
							...
							<input type="text" class="form-control" name="postcode" placeholder="Masukan kode pos" value="<?php echo isset($zip) ? $zip : ' ';?>">
							<span class="text-danger msg-error"><?php echo $zipErr; ?></span>
						</div>
							
						<div class="col-sm-6 form-group">
							<label>Nomor Telepon :</label>
							<input type="text" class="form-control" name="phone" maxlength="14" placeholder="Masukan nomor telepon Anda" value="+62">
					...
					<div class="row">
						<div class="col-sm-4 form-group">
							<label>Email :</label>
							<input type="text" class="form-control" name="email" placeholder="Masukan email" value="<?php echo isset($email) ? $email : ' ';?>">
							<span>Example: yourname@gmail.com</span><br/>
							<span class="text-danger msg-error"><?php echo $emailErr; ?></span>
						</div>
						<div class="col-sm-4 form-group">
							<label>Kata Sandi :</label>
							<input type="password" class="form-control" name="pass" placeholder="Masukan sandi">
							<span class="text-danger msg-error"><?php echo $passErr; ?></span>
						</div>
						<div class="col-sm-4 form-group">
							<label>Konfirmasi Kata Sandi :</label>
							<input type="password" class="form-control" name="cpass" placeholder="Konfirmasi sandi">
					...
					<center>
						<div class="form-group">
							<div class="checkboxcss"><input type="checkbox" name="agree" value="1"> Saya setuju mengikuti ketentuan ini</div>
